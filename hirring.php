 ...
 <table id="dash-table" class="table table-hover">
     ...
     <tbody>
        ...
        $sql =
            "SELECT * FROM `tblcompany` c,`tbljob` j WHERE c.`COMPANYID`=j.`COMPANYID` AND COMPANYNAME LIKE '%" .
            $COMPANYNAME .
        ...
        foreach ($cur as $result) {
            ...
            echo '<td>' .
                date_format(date_create($result->DATEPOSTED), 'm/d/Y') .
                '</td>';
            echo '</tr>';
        }
        ?> 
...
?>    
            <!--  <div class="container">
             <div class="mg-available-rooms">
                    <h5 class="mg-sec-left-title">Date Posted :  <?php echo date_format(
                        date_create($result->DATEPOSTED),
                        'M d, Y'
                    ); ?></h5>
                        <div class="mg-avl-rooms">
                            <div class="mg-avl-room">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <h2 class="mg-avl-room-title"><?php echo $result->COMPANYNAME .
                                            '/ ' .
                                            $result->OCCUPATIONTITLE; ?> </h2>
                                        ...
                                        <div class="row mg-room-fecilities">
                                            <div class="col-sm-6">
                                                <ul>
                                                    ...
                                                    <li><i class="fp-ht-food"></i>Salaries : <?php echo number_format(
                                                        $result->SALARIES,
                                                        2
                                                    ); ?></li>
